var shengyuan = angular.module('shengyuan', ['ngResource', 'ngRoute', 'ngSanitize', 'pascalprecht.translate']).config(['$routeProvider', '$translateProvider', function ($routeProvider, $translateProvider) {
